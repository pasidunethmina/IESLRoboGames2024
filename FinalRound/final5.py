...
# define nessecary functions for movements
def turn_right():
...
def color_percentages(color):
    ...
    cv2.line(frame, (width//2, 0), (width//2, 6*height//7), (0, 255, 0), 2)
